    ...
    <el-table :data="currentData" fixed highlight-current-row style="width: 100%;">
      ...
      <el-table-column fixed="right" label="操作" width="350" align="center">
        <template slot-scope="scope">
          ...
          <el-button v-if="scope.row.AdviserMeid" type="warning" size="small" @click="$router.push('/teacher/list?setm='+scope.row.cid+'&name='+scope.row.Name+'')">
            更换班主任</el-button>
          <el-button v-else type="success" size="small" @click="$router.push('/teacher/list?setm='+scope.row.cid+'&name='+scope.row.Name+'')">
            添加班主任</el-button>
