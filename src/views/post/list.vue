		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				<el-form-item label="班级ID">
					<el-input v-model="filters.cid" placeholder="班级ID"></el-input>
				</el-form-item>

				<el-form-item label="数据类型">
					<el-radio-group v-model="filtersType" @change="getData">
		...
		<template>
			<el-table :data="currentData" highlight-current-row v-loading="loading" style="width: 100%;">
				...
				<el-table-column prop="comment" label="评论">
					<template scope="scope" >
						<el-button type="primary" size="small" 
							v-if="scope.row.comment.length" 
							@click="handleComment(scope.row.comment)">
